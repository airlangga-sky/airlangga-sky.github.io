...
class UlarTanggaApp:
    def __init__(self, master):
        ...
        # Memuat gambar papan permainan
        self.image = tk.PhotoImage(file="1.png")  # Ganti dengan nama file gambar Anda
        self.label_image = tk.Label(master, image=self.image)
    ...
    def kerjakan_soal(self, soal):
        jawaban = simpledialog.askinteger("Soal", soal)
